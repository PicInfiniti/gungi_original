! function () {
      ...
      return o.canTrickleIceCandidates = !!l && l.substr(14).split(" ").indexOf("trickle") >= 0, c.forEach((function (n, c) {
        ...
        if (h || "application" === f && ("DTLS/SCTP" === m || "UDP/DTLS/SCTP" === m)) o.transceivers[c] = {
          ...
          if (("offer" === i.type || "answer" === i.type) && !h && u && c > 0 && o.transceivers[c] && (o._disposeIceAndDtlsTransports(c), o.transceivers[c].iceGatherer = o.transceivers[0].iceGatherer, o.transceivers[c].iceTransport = o.transceivers[0].iceTransport, o.transceivers[c].dtlsTransport = o.transceivers[0].dtlsTransport, o.transceivers[c].rtpSender && o.transceivers[c].rtpSender.setTransport(o.transceivers[0].dtlsTransport), o.transceivers[c].rtpReceiver && o.transceivers[c].rtpReceiver.setTransport(o.transceivers[0].dtlsTransport)), "offer" !== i.type || h) {
            if ("answer" === i.type && !h) {
              C = (b = o.transceivers[c]).iceGatherer, _ = b.iceTransport, S = b.dtlsTransport, T = b.rtpReceiver, k = b.sendEncodingParameters, P = b.localCapabilities, o.transceivers[c].recvEncodingParameters = w, o.transceivers[c].remoteCapabilities = D, o.transceivers[c].rtcpParameters = O, M.length && "new" === _.state && (!d && !I || u && 0 !== c ? M.forEach((function (e) {
                Q(b.iceTransport, e)
              })) : _.setRemoteCandidates(M)), u && 0 !== c || ("new" === _.state && _.start(C, E, "controlling"), "new" === S.state && S.start(x)), !Y(b.localCapabilities, b.remoteCapabilities).codecs.filter((function (e) {
                return "rtx" === e.name.toLowerCase()
              })).length && b.sendEncodingParameters[0].rtx && delete b.sendEncodingParameters[0].rtx, o._transceive(b, "sendrecv" === v || "recvonly" === v, "sendrecv" === v || "sendonly" === v), !T || "sendrecv" !== v && "sendonly" !== v ? delete b.rtpReceiver : (R = T.track, y ? (a[y.stream] || (a[y.stream] = new e.MediaStream), r(R, a[y.stream]), s.push([R, T, a[y.stream]])) : (a.default || (a.default = new e.MediaStream), r(R, a.default), s.push([R, T, a.default])))
            }
          } else {
            (b = o.transceivers[c] || o._createTransceiver(f)).mid = g, b.iceGatherer || (b.iceGatherer = o._createIceGatherer(c, u)), M.length && "new" === b.iceTransport.state && (!I || u && 0 !== c ? M.forEach((function (e) {
              Q(b.iceTransport, e)
            })) : b.iceTransport.setRemoteCandidates(M)), P = e.RTCRtpReceiver.getCapabilities(f), t < 15019 && (P.codecs = P.codecs.filter((function (e) {
              return "rtx" !== e.name
            ...
            if ("sendrecv" === v || "sendonly" === v) {
              if (A = !b.rtpReceiver, T = b.rtpReceiver || new e.RTCRtpReceiver(b.dtlsTransport, f), A) R = T.track, y && "-" === y.stream || (y ? (a[y.stream] || (a[y.stream] = new e.MediaStream, Object.defineProperty(a[y.stream], "id", {
                get: function () {
                  return y.stream
                }
              ...
              }), j = a[y.stream]) : (a.default || (a.default = new e.MediaStream), j = a.default)), j && (r(R, j), b.associatedRemoteMediaStreams.push(j)), s.push([R, T, j])
  ...
  function Pe(t) {
    if (!(!t.RTCIceCandidate || t.RTCIceCandidate && "foundation" in t.RTCIceCandidate.prototype)) {
      ...
      t.RTCIceCandidate = function (t) {
        ...
        return new r(t)
      }, t.RTCIceCandidate.prototype = r.prototype, C(t, "icecandidate", (function (e) {
  ...
  var Ie, Me, je = function () {
    ...
    Fe = new((Me = function () {
      this.CLOUD_HOST = "0.peerjs.com", this.CLOUD_PORT = 443, this.chunkedBrowsers = {
        Chrome: 1,
        chrome: 1
      }, this.chunkedMTU = 16300, this.defaultConfig = Ne, this.browser = Be.getBrowser(), this.browserVersion = Be.getVersion(), this.supports = function () {
        var e, t = {
  ...
  var ze, Ge = Object.prototype.hasOwnProperty,
    Ve = "~";
  ...
  Object.create && (Je.prototype = Object.create(null), (new Je).__proto__ || (Ve = !1)), Ye.prototype.eventNames = function () {
    var e, t, r = [];
  ...
  }, Ye.prototype.off = Ye.prototype.removeListener, Ye.prototype.addListener = Ye.prototype.on, Ye.prefixed = Ve, Ye.EventEmitter = Ye, ze = Ye;
  var qe = {};
  t(qe, "LogLevel", (function () {
    return Qe
  }), (function (e) {
    return Qe = e
  })), t(qe, "default", (function () {
    return st
  }), (function (e) {
    return st = e
  }));
  var Qe, Xe = function (e, t) {
  ...
  var et, tt, rt, nt, it, ot, at = (et = function () {
  ...
  var dt, ut = (dt = function (e, t) {
    ...
    mt = function (e) {
      ...
      return ut(t, e), t.prototype.start = function (e, t) {
        var r = this;
        this._id = e;
        var n = "".concat(this._baseUrl, "&id=").concat(e, "&token=").concat(t);
        !this._socket && this._disconnected && (this._socket = new WebSocket(n + "&version=" + pt.version), this._disconnected = !1, this._socket.onmessage = function (e) {
          var t;
          try {
        ...
        var e, t, r = ft([], lt(this._messagesQueue), !1);
        this._messagesQueue = [];
        try {
    ...
    vt = {};
  t(vt, "MediaConnection", (function () {
    return Et
  }), (function (e) {
    return Et = e
  }));
  var yt = {};
  t(yt, "Negotiator", (function () {
    return _t
  }), (function (e) {
    return _t = e
  }));
  var gt = function () {
    ...
    _t = function () {
      ...
      return e.prototype.startConnection = function (e) {
        ...
        qe.default.log("Listening for ICE candidates."), e.onicecandidate = function (e) {
          e.candidate && e.candidate.candidate && (qe.default.log("Received ICE candidates for ".concat(r, ":"), e.candidate), o.socket.send({
            type: ot.Candidate,
            payload: {
        ...
        }, qe.default.log("Listening for data channel"), e.ondatachannel = function (e) {
          qe.default.log("Received data channel");
          var t = e.channel;
          o.getConnection(r, n).initialize(t)
        }, qe.default.log("Listening for remote stream"), e.ontrack = function (e) {
        ...
        return bt(this, void 0, Promise, (function () {
          ...
          return Ct(this, (function (s) {
            switch (s.label) {
              ...
              case 2:
                r = s.sent(), qe.default.log("Created offer."), this.connection.options.sdpTransform && "function" == typeof this.connection.options.sdpTransform && (r.sdp = this.connection.options.sdpTransform(r.sdp) || r.sdp), s.label = 3;
              case 3:
                return s.trys.push([3, 5, , 6]), [4, e.setLocalDescription(r)];
              case 4:
                return s.sent(), qe.default.log("Set localDescription:", r, "for:".concat(this.connection.peer)), n = {
                  sdp: r,
                  type: this.connection.type,
                  connectionId: this.connection.connectionId,
                  metadata: this.connection.metadata,
                  browser: Fe.browser
                }, this.connection.type === tt.Data && (i = this.connection, n = gt(gt({}, n), {
                  label: i.label,
                  reliable: i.reliable,
              ...
              case 5:
                return "OperationError: Failed to set local offer sdp: Called in wrong state: kHaveRemoteOffer" != (o = s.sent()) && (t.emitError(rt.WebRTC, o), qe.default.log("Failed to setLocalDescription, ", o)), [3, 6];
              case 6:
                return [3, 8];
              case 7:
        ...
        return bt(this, void 0, Promise, (function () {
          ...
          return Ct(this, (function (o) {
            switch (o.label) {
              ...
              case 2:
                r = o.sent(), qe.default.log("Created answer."), this.connection.options.sdpTransform && "function" == typeof this.connection.options.sdpTransform && (r.sdp = this.connection.options.sdpTransform(r.sdp) || r.sdp), o.label = 3;
              case 3:
                return o.trys.push([3, 5, , 6]), [4, e.setLocalDescription(r)];
              case 4:
                return o.sent(), qe.default.log("Set localDescription:", r, "for:".concat(this.connection.peer)), t.socket.send({
                  type: ot.Answer,
                  payload: {
                    sdp: r,
                    type: this.connection.type,
  ...
  var Tt = function () {
    ...
    kt = function (e) {
      ...
      return Tt(t, e), Object.defineProperty(t.prototype, "open", {
        get: function () {
          return this._open
        },
        enumerable: !1,
    ...
    Et = function (e) {
      function t(r, n, i) {
        ...
        return o._localStream = o.options._stream, o.connectionId = o.options.connectionId || t.ID_PREFIX + Fe.randomToken(), o._negotiator = new yt.Negotiator(o), o._localStream && o._negotiator.startConnection({
          _stream: o._localStream,
          originator: !0
        }), o
      }
      return wt(t, e), Object.defineProperty(t.prototype, "type", {
        get: function () {
          return tt.Media
        },
        enumerable: !1,
        ...
        if (void 0 === t && (t = {}), this._localStream) qe.default.warn("Local stream already exists on this MediaConnection. Are you answering a call twice?");
          ...
          this._localStream = e, t && t.sdpTransform && (this.options.sdpTransform = t.sdpTransform), this._negotiator.startConnection(Pt(Pt({}, this.options._payload), {
            _stream: e
          }));
        ...
        this._negotiator && (this._negotiator.cleanup(), this._negotiator = null), this._localStream = null, this._remoteStream = null, this.provider && (this.provider._removeConnection(this), this.provider = null), this.options && this.options._stream && (this.options._stream = null), this.open && (this._open = !1, e.prototype.emit.call(this, "close"))
      }, t.ID_PREFIX = "mc_", t
    }(St.BaseConnection),
    xt = {};
  t(xt, "DataConnection", (function () {
    return At
  }), (function (e) {
    return At = e
  }));
  var Dt = {};
  t(Dt, "EncodingQueue", (function () {
    return It
  }), (function (e) {
    return It = e
  }));
  var Ot = function () {
    ...
    It = function (e) {
      ...
      return Ot(t, e), Object.defineProperty(t.prototype, "queue", {
        get: function () {
          return this._queue
        },
        enumerable: !1,
    ...
    At = function (e) {
      function t(r, n, i) {
        ...
        })), o._negotiator = new yt.Negotiator(o), o._negotiator.startConnection(o.options._payload || {
          originator: !0
        }), o
      }
      return Mt(t, e), Object.defineProperty(t.prototype, "type", {
        get: function () {
          return tt.Data
        },
        enumerable: !1,
        ...
        var e = this;
        Fe.supports.binaryBlob && !Fe.supports.reliable || (this.dataChannel.binaryType = "arraybuffer"), this.dataChannel.onopen = function () {
        ...
        if (this.serialization === nt.Binary || this.serialization === nt.BinaryUTF8) {
          if (i === Blob) return void Fe.blobToArrayBuffer(n, (function (e) {
            var t = Fe.unpack(e);
            r.emit("data", t)
          }));
        ...
        this._buffer = [], this._bufferSize = 0, this._chunkedData = {}, this._negotiator && (this._negotiator.cleanup(), this._negotiator = null), this.provider && (this.provider._removeConnection(this), this.provider = null), this.dataChannel && (this.dataChannel.onopen = null, this.dataChannel.onmessage = null, this.dataChannel.onclose = null, this._dc = null), this._encodingQueue && (this._encodingQueue.destroy(), this._encodingQueue.removeAllListeners(), this._encodingQueue = null), this.open && (this._open = !1, e.prototype.emit.call(this, "close"))
  ...
  var Bt = function (e, t, r, n) {
    ...
    Ft = function () {
      ...
      return e.prototype._buildRequest = function (e) {
        ...
        return s.searchParams.set("ts", "".concat(Date.now()).concat(Math.random())), s.searchParams.set("version", pt.version), fetch(s.href, {
          ...
          return Nt(this, (function (n) {
            switch (n.label) {
              ...
              case 1:
                ...
                return [2, e.text()];
              case 2:
                throw t = n.sent(), qe.default.error("Error retrieving ID", t), r = "", "/" === this._options.path && this._options.host !== Fe.CLOUD_HOST && (r = " If you passed in a `path` to your self-hosted PeerServer, you'll also need to pass in that same path when creating a new Peer."), new Error("Could not get an ID from the server." + r);
              case 3:
                return [2]
            }
          }))
    ...
    Jt = function (e) {
      function t(r, n) {
        ...
        return o._id = null, o._lastServerId = null, o._destroyed = !1, o._disconnected = !1, o._open = !1, o._connections = new Map, o._lostMessages = new Map, r && r.constructor == Object ? n = r : r && (i = r.toString()), n = zt({
          debug: 0,
          host: Fe.CLOUD_HOST,
          port: Fe.CLOUD_PORT,
          path: "/",
        ...
        }, n), o._options = n, "/" === o._options.host && (o._options.host = window.location.hostname), o._options.path && ("/" !== o._options.path[0] && (o._options.path = "/" + o._options.path), "/" !== o._options.path[o._options.path.length - 1] && (o._options.path += "/")), void 0 === o._options.secure && o._options.host !== Fe.CLOUD_HOST ? o._options.secure = Fe.isSecure() : o._options.host == Fe.CLOUD_HOST && (o._options.secure = !0), o._options.logFunction && qe.default.setLogFunction(o._options.logFunction), qe.default.logLevel = o._options.debug || 0, o._api = new Lt.API(n), o._socket = o._createServerConnection(), Fe.supports.audioVideo || Fe.supports.data ? i && !Fe.validateId(i) ? (o._delayedAbort(rt.InvalidID, 'ID "'.concat(i, '" is invalid')), o) : (i ? o._initialize(i) : o._api.retrieveId().then((function (e) {
          return o._initialize(e)
        })).catch((function (e) {
          return o._abort(rt.ServerError, e)
        })), o) : (o._delayedAbort(rt.BrowserIncompatible, "The current browser does not support WebRTC"), o)
      }
      return Ut(t, e), Object.defineProperty(t.prototype, "id", {
        get: function () {
          return this._id
        },
        enumerable: !1,
        ...
        return t.on(it.Message, (function (t) {
          e._handleMessage(t)
